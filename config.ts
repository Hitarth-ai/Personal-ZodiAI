...
export const OWNER_NAME = "A37 - Hitarth & Yatharth";

export const WELCOME_MESSAGE = `Hello! I'm ${AI_NAME}, your AI astrology assistant by ${OWNER_NAME}.I’m for reflection & entertainment – not professional advice.`
